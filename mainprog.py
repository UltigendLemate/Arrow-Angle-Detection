...
def getcont(img,imgcnt):
    ...
    for cnt in contours:
        ...
        if area>areamin:
            ...
            # print(approx)
            cv2.putText(imageContour,"Points : " + str(len(approx)),(10,430),cv2.FONT_HERSHEY_COMPLEX,0.7,(0,255,0),2)
            if len(approx) == 7:
                ...
                cv2.putText(imageContour,"Points : " + str(abs(math.atan(m)*180/PI)),(10,460),cv2.FONT_HERSHEY_COMPLEX,0.7,(0,255,0),2)
